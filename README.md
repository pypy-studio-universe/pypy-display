...
1. Tải file `PypyDisplay.dmg` từ mục **Releases**.
...
1. Download `PypyDisplay.dmg` from **Releases**.
...
<p align="center">
  <img src="Assets/Donate/MoMo-QR.png" alt="PypyDisplay MoMo donation QR code" width="360">
</p>
